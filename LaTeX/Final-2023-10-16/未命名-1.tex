...
\newpage
\subsection{前缀和优化建图} 
\includegraphics[scale=0.55]{qzh.png}
\begin{lstlisting}
vector<int>v[maxn];
vector<int>p;
int n,m,k;
...
\newpage
\subsection{SAM:  出现次数大于等于k次的最长子串} 
首先建出后缀树
